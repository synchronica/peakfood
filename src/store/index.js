...
export const store = new Vuex.Store({
  ...
  actions: {
    ...
    getModuleManager ({ state, commit }, id) {
      const formData = new FormData()
      formData.set('id', id)
      instance.post('/api/ModuleManager', formData)
        .then(response => {

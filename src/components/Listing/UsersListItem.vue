            ...
            >
              ...
              <div v-if="field.field === 'active'" class="w-sm-100 glyph">
                <i
                  ...
                  class="glyph-icon simple-icon-energy"
                  :class="{ active: data[field.field] === '1' }"
                />
              </div>
              ...
              <p
                v-else-if="field.type === 'select' && field.field !== 'active'"
              ...
              <p
                ...
                class="mb-1 text-muted text-small w-sm-100"
                v-html="formatDate(data[field.field])"
              />
              <p
                v-else-if="
                  field.action !== 'fileOpen' &&

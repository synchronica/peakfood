                ...
                <b-colxx xxs="12" md=10  class="mx-auto my-auto">
                  <b-card class="auth-card" no-body>
                      ...
                      <div class="form-side">
                        ...
                        <b-img class="d-xs-block mb-5" :src="logo" height="60px" alt="Responsive image"></b-img>
                        </router-link>
                        ...
                        <b-button type="submit" variant="primary" size="lg" class="btn-shadow" @click="goBack">{{ $t('pages.go-back-home')}}</b-button>
                    </div>
                  </b-card>
                </b-colxx>
              </b-row>

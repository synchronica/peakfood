...
<b-row>
          ...
          <b-button-group>
            ...
            <b-dropdown split right @click="selectAll(true)" class="check-button" variant="primary">
              ...
              >
                ...
                >
                <span
                  :class="{'custom-control-label' :true, 'indeterminate' : isAnyItemSelected }" />
              </label>
              <b-dropdown-item @click="removeFavorites">Rimuovi dal menù</b-dropdown-item>
            </b-dropdown>
          </b-button-group>
        </div>
  ...
  <b-modal
    ...
    <b-row class="justify-content-center">
      <b-spinner style="width: 3rem; height: 3rem;" variant="primary" type="grow" label="Spinning" />
    </b-row>
  </b-modal>
  ...
  <b-modal
    ...
    <b-row v-if="error" class="justify-content-center py-4">
      <div class="w-100 d-flex justify-content-center mb-4">
        <i style="color: red; font-size: 40px;" class="simple-icon-exclamation"/>
      </div>
...
export default {
  ...
  methods: {
    ...
    async onLaunchAlgorythm () {
      ...
      //     .get(
      //       apiBase + '?lancia_algoritmo=' + this.moduleId + '&token=1'
      //     )

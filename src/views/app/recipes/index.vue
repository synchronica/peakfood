      ...
      <b-container>
        <b-row class="justify-content-center">
          <b-form @submit.prevent="onAcquistaRicetta">
            ...
            <span v-if="validated === false" style="color: red" class="small"
              >Devi scegliere una categoria</span
            >
...
export default {
  ...
  methods: {
    ...
    async onAcquistaRicetta() {
      ...
      try {
        const response = await instance.post("/api/AcquistaRicetta", formData);
